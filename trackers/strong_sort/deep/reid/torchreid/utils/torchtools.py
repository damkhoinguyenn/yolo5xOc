...
def load_checkpoint(fpath):
    ...
    Examples::
        >>> from trackers.strong_sort.deep.reid.torchreid.utils import load_checkpoint
...
def resume_from_checkpoint(fpath, model, optimizer=None, scheduler=None):
    ...
    Examples::
        >>> from trackers.strong_sort.deep.reid.torchreid.utils import resume_from_checkpoint
        >>> fpath = 'log/my_model/model.pth.tar-10'
...
def open_all_layers(model):
    ...
    Examples::
        >>> from trackers.strong_sort.deep.reid.torchreid.utils import open_all_layers
...
def open_specified_layers(model, open_layers):
    ...
    Examples::
        >>> from trackers.strong_sort.deep.reid.torchreid.utils import open_specified_layers
...
def count_num_param(model):
    ...
    Examples::
        >>> from trackers.strong_sort.deep.reid.torchreid.utils import count_num_param
...
def load_pretrained_weights(model, weight_path):
    ...
    Examples::
        >>> from trackers.strong_sort.deep.reid.torchreid.utils import load_pretrained_weights
